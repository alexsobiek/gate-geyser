module github.com/alexsobiek/gate-geyser

go 1.23.5

require (
	buf.build/gen/go/minekube/connect/protocolbuffers/go v1.36.4-20240220124425-904ce30425c9.1 // indirect
	...
	go.minekube.com/gate v0.47.0 // indirect
